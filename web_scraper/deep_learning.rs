use crate::{
    ...
    constant::{DEEP_LEARNING_SITEMAP_URL, DEEP_LEARNING_STORAGE_CONSTANT},
...
pub async fn scrape_deep_learning_sitemap() -> Result<ScrapedEngineeringItems> {
    match local_storage::find_stored_item(DEEP_LEARNING_STORAGE_CONSTANT).await {
        Some(i) => Ok(i),
        None => {
